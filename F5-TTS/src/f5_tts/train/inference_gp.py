...
from f5_tts.model import CFM, DiT, UNetT, Inferencer_gp  # noqa: F401. used for config
...
@hydra.main(version_base="1.3", config_path=str(files("f5_tts").joinpath("configs")), config_name="F5TTS_v1_Base_debug_Emilia_gp")
