...
def main():
    ...
    parser.add_argument("-n", "--expname", default="F5TTS_v1_Base_debug_Emilia_bpe")
    parser.add_argument("-c", "--ckptstep", default=1, type=int)

    parser.add_argument("-nfe", "--nfestep", default=2, type=int)
    parser.add_argument("-o", "--odemethod", default="euler")
    parser.add_argument("-ss", "--swaysampling", default=-1, type=float)

    parser.add_argument("-t", "--testset", default="ls_pc_test_clean")
    parser.add_argument(
        "-p", "--librispeech_test_clean_path", default="/hpc_stor03/sjtu_home/qingyu.liu/F5-TTS-main_v104/LibriSpeech/test-clean", type=str
    )

    parser.add_argument("--local", action="store_true", default=True, help="Use local vocoder checkpoint directory")
    ...
    if mel_spec_type == "vocos":
        vocoder_local_path = "/hpc_stor03/sjtu_home/qingyu.liu/F5-TTS-main_v104/vocos-mel-24khz"
