...
from f5_tts.model import CFM_CTC
            ...
            for batch in current_dataloader:
                with self.accelerator.accumulate(self.model):
                    ...
                    loss, loss_components, cond, pred = self.model(
                        mel_spec, text=text_inputs, lens=mel_lengths, text_lens=text_lengths, noise_scheduler=self.noise_scheduler
                    )
                    ...
                    torchaudio.save(
                        f"{log_samples_path}/ttt.wav", gen_audio, target_sample_rate
                    )
                    # ---
